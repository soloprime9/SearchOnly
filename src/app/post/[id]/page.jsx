...
function Post({ id }) {
  ...
  return (
    <>
      <Head>
        <title>{post.content ? `${post.content} | Fondpeace` : 'Fondpeace'}</title>
        <meta name="description" content={post.content ? post.content.slice(0, 150) : 'Fondpeace latest post.'} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href={`https://www.fondpeace.com/post/${post.id}`} />
        <meta property="og:title" content={post.content ? post.content : 'Fondpeace Post'} />
        <meta property="og:description" content={post.content ? post.content.slice(0, 150) : 'Fondpeace post content'} />
        <meta property="og:image" content={post.imageURL ? post.imageURL : 'https://www.fondpeace.com/default-og-image.jpg'} />
        <meta property="og:url" content={`https://www.fondpeace.com/post/${post.id}`} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={post.content ? post.content : 'Fondpeace Post'} />
        <meta name="twitter:description" content={post.content ? post.content.slice(0, 150) : 'Fondpeace post content'} />
        <meta name="twitter:image" content={post.imageURL ? post.imageURL : 'https://www.fondpeace.com/default-og-image.jpg'} />
      </Head>
          ...
          <div className="border-1 border-gray-300 rounded-md h-screen">
            <div className="rounded-xl h-auto w-full p-2">
              ...
              <div className="flex justify-center">
                <img
                  src={post.imageURL || "https://www.fondpeace.com/default-og-image.jpg"}
                  alt="hello"
