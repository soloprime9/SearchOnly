...
export default function DMCA() {
  return (
    <>
      <Head>
        <title>DMCA Policy - FondPeace</title>
        <meta
          name="description"
          content="Digital Millennium Copyright Act (DMCA) Policy for Today Written Update. Learn how we handle copyright infringement notices."
        />
      </Head>

      <main className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-4">
          DMCA Policy for <b>FondPeace</b>
        </h1>

        <p>
          This Digital Millennium Copyright Act Policy (“Policy”) applies to the{" "}
          <b>https://fondpeace.com</b> website (“Website” or “Service”)
          and any of its related products and services (collectively, “Services”)
          and outlines how this Website operator (“Operator”, “we”, “us” or “our”)
        ...
        <p className="mt-4">
          ...
          found on the U.S. Copyright Office{" "}
          <a
        ...
        <p>
          ...
          before filing a notification with us. Our DMCA page was generated with
          the help of the RaptorKit's{" "}
          <a
            href="https://raptorkit.com/dmca-generator/"
            target="_blank"
            rel="noreferrer noopener"
            className="text-blue-600 underline"
          >
        ...
        <p>
          ...
          response may include the removal or restriction of access to the
          allegedly infringing material.
        </p>

        <p>
          If we remove or restrict access to materials or terminate any account
        ...
        <h2 className="text-2xl font-semibold mt-6">Changes and amendments</h2>
        <p>
        ...
        <p>
          Visit our Contact us page or mail us at{" "}
          <b>serialupdate2626@gmail.com</b>
        </p>
        <p>Please allow us 2-5 business working days for an email response.</p>
      </main>
    </>
  );
}
