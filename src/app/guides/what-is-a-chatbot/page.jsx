    ...
    <main className="bg-gray-50 min-h-screen">
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white border border-gray-200 rounded-lg shadow-lg">
          <article className="prose prose-slate max-w-none px-6 sm:px-10 lg:px-16 py-10">
            ...
            <header className="mb-10 border-b border-gray-200 pb-6">
              ...
              <p className="mt-2 text-gray-500">Reference article</p>
            </header>

            {/* Content */}
            <div className="space-y-8 leading-relaxed text-gray-800 text-[16px] sm:text-[17px]">
