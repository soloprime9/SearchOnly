<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
  ...
  <div role="status" class="p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700">
    ...
    <div class="flex items-center justify-center h-48 mt-4 bg-gray-300 rounded-sm dark:bg-gray-700">
